...
namespace Substring
{
    class Program
    {
        ...
        {
            // Substring () method : It is used as cutting text to any length you want in the string 
            // Form : string value.Substring(starting index number , last index number in the length);


            // case 1 : starting index number is "0"
            ...
            // Last index number in the length can be omitted 
